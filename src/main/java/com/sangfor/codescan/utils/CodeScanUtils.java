...
package com.sangfor.codescan.utils;
 ...
 */
public final class CodeScanUtils {

  /**
   * Default logger.
   */
  public static final Logger LOG = LoggerFactory.getLogger("CodeScanPlugin");

  private CodeScanUtils() {
    // only static methods
  }
